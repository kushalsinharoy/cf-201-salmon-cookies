...
daily sales projection for salmon cookies accross different locations.
*******************************************************/
'use-strict';
      ...
      for (var i = 0; i < locationArrayLength - 1; i++) {
        if (
          ...
          salmonCookieStoreLocations.length =
            salmonCookieStoreLocations.length - 1; //delete the duplicate from array
...
locationDetailsInputForm.addEventListener(
  'submit',
  salmonCookieLocationInputFormData
);
